...
namespace lab5
{
    public class DepositAccount : Account
    {
        public class DepositParameters : Parameters
        {
            ...
            public DepositParameters(DateTime date, int firstSum, int secondSum, int percentBefore, int percentBetween, int percentAfter)
            {
                _date = date;
                _firstSum = firstSum;
        ...
        public DepositAccount(DepositParameters parameters, DateTime date, int sum)
        {
